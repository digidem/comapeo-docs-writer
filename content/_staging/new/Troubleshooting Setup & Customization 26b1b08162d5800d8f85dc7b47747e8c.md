...
- **👣 Step by step instructions**
    ...
    **Step 1:** Go to Android settings. You can find them by going to the main android menu and search for “Settings”. It usually has a *gear* (⚙️) icon.
    ...
    ![WhatsApp Image 2025-11-26 at 10.51.47 AM.jpeg](Troubleshooting%20Setup%20&%20Customization/3025f038-d4c6-4918-b4a2-a1800a2c35d9.png)
    ...
    **Step 2:** Open it, and inside it look for the “Apps” option. This will display all the installed apps in the device. It usually has a search bar where you can type
    ...
    ![WhatsApp Image 2025-11-26 at 10.54.27 AM.jpeg](Troubleshooting%20Setup%20&%20Customization/6304e0c1-c9da-4038-aa47-650af0038c05.png)
    
    **Step 3:** Type **CoMapeo** and click on it
    
    ![WhatsApp Image 2025-11-26 at 10.51.47 AM(1).jpeg](Troubleshooting%20Setup%20&%20Customization/fccb446a-a821-4c84-aff1-2c29851371e4.png)
    
    **Step 4:** Once inside the *App info* menu, select *Storage & Cache*
    
    ![WhatsApp Image 2025-11-26 at 10.51.47 AM(2).jpeg](Troubleshooting%20Setup%20&%20Customization/d056f819-47ce-4429-84a7-ca8db6e9bc83.png)
    ...
    **Step 5:** Inside *Storage*, select *CLEAR CACHE* which has a trash icon (🗑️). As said above, **beware of only selecting *CLEAR CACHE* and not *CLEAR STORAGE* since this will delete all data, basically reseting CoMapeo as if you just installed it.**
    ...
    ![WhatsApp Image 2025-11-26 at 10.51.47 AM(3).jpeg](Troubleshooting%20Setup%20&%20Customization/40f1cd14-af15-492c-94b6-8f237bf277f5.png)
...
- **👣 Step by step instructions**
    ...
    **Step 1:** After selecting the *Import Categories* button, the Android browser will appear to let you select the intended category file. But it may happen that the filename is cut, so you can’t see the full name. 
    ...
    ![WhatsApp Image 2025-11-26 at 11.16.16 AM.jpeg](Troubleshooting%20Setup%20&%20Customization/e1def567-46ee-445d-917e-66429b0d7e87.png)
    ...
    **Step 2:** If you want to be sure you’re selecting the correct file, you can select and hold your finger on top of the file you want, which will show the correct file name and select that file
    ...
    ![WhatsApp Image 2025-11-26 at 11.16.16 AM(1).jpeg](Troubleshooting%20Setup%20&%20Customization/7e46da68-5b97-49b6-9776-88bf55decc62.png)
    
    **Step 3:** If the selected file is the intended one, press select on the top right corner
    
    ![WhatsApp Image 2025-11-26 at 11.16.16 AM(1).jpeg](Troubleshooting%20Setup%20&%20Customization/93e8aae6-5888-4059-be42-8ec5077419bf.png)
...
- **👣 Step by step instructions**
    ...
    **Step 1:** Open **CoMapeo** and go to the **About CoMapeo** menu in the **Comapeo Settings** menu
    ...
    ![WhatsApp Image 2025-11-26 at 11.50.40 AM(1).jpeg](Troubleshooting%20Setup%20&%20Customization/1538f652-fa94-4cad-90be-9cbf5eece8c3.png)
    
    **Step 2:** Check the **CoMapeo version** field and see if the version is higher or equal than **7.0**
    
    ![WhatsApp Image 2025-11-26 at 11.50.40 AM.jpeg](Troubleshooting%20Setup%20&%20Customization/f74466d7-9d1f-4f33-b24a-021664b93212.png)
