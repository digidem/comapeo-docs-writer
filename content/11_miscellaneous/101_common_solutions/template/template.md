...
↳ Page Order: 101
Language: English
Parent item: Common Solutions (Common%20Solutions%202a71b08162d58037a4afe1f35a77bbe0.md)
...
- **👣 Step by step instructions**
    ...
    **Step 1:** Swipe up from the bottom while CoMapeo is selected, to see all the open applications on the phone
    ...
    ![WhatsApp Image 2025-11-27 at 12.40.47 PM(1).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_12.40.47_PM(1).jpeg)
    
    **Step 2:** Swipe up again centering your finger on **CoMapeo** to close it
    
    ![WhatsApp Image 2025-11-27 at 12.40.47 PM.jpeg](./images/WhatsApp_Image_2025-11-27_at_12.40.47_PM.jpeg)
    
    **Step 3:** Go to the **CoMapeo** app icon in your main screen or apps screen menu and select **CoMapeo**
    
    ![WhatsApp Image 2025-11-27 at 12.40.47 PM(2).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_12.40.47_PM(2).jpeg)
...
- **👣 Step by step instructions**
    ...
    **Step 1:** Go to the Android Configuration screen (⚙️)
    ...
    ![WhatsApp Image 2025-11-27 at 12.45.20 PM(1).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_12.45.20_PM(1).jpeg)
    ...
    **Step 2:** See the available storage. Android will try to show which type of files are consuming more storage. So, for example, if most of the space is fill with videos, or images, one can go to the android File Manager (📁) and delete files so that there’s free space for new collected data (from the user, or exchanged with collaborators)
    ...
    ![WhatsApp Image 2025-11-27 at 12.45.20 PM.jpeg](./images/WhatsApp_Image_2025-11-27_at_12.45.20_PM.jpeg)
...
- **👣 Step by step instructions**
    ...
    **Step 1:** Long press the *block device* button that’s usually located on one side of the phone. Is pretty common that devices have three buttons: two buttons to lower and increase volume, and one button to block (turn off the screen) the device.
    ...
    ![WhatsApp Image 2025-11-27 at 12.55.22 PM.jpeg](./images/WhatsApp_Image_2025-11-27_at_12.55.22_PM.jpeg)
...
- **GPS** :app-icon-gps20: **(while the app is being used)**: for geolocation of the user and adding observations with correct coordinates
- **GPS** :app-icon-gps20: **(all the time)**: for recording tracks while the app is not focused, or the phone has the screen off
- **Audio** :app-icon-add-audio: **(while the app is being used):** for recording audio attached to observations
...
- **👣 Step by step instructions**
    ...
    **Step 1:** Go to the Android Configuration screen (⚙️)
    ...
    ![WhatsApp Image 2025-11-27 at 12.45.20 PM(1).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_12.45.20_PM(1)%201.jpeg)
    
    **Step 2:** Go to the Apps menu
    
    ![WhatsApp Image 2025-11-27 at 1.17.00 PM(2).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_1.17.00_PM(2).jpeg)
    
    **Step 3:** Look for **CoMapeo** in the list of apps (you have a search bar for quickly finding it)
    
    ![WhatsApp Image 2025-11-27 at 1.17.00 PM(1).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_1.17.00_PM(1).jpeg)
    
    **Step 4:** On the App info screen, select the **Permissions** item
    
    ![WhatsApp Image 2025-11-27 at 1.17.00 PM(3).jpeg](Common%20Solutions/WhatsApp_Image_2025-11-27_at_1.17.00_PM(3).jpeg)
    ...
    **Step 5:** There, you will see a list of **Allowed** and **Not allowed** permissions. Clicking on a specific item (like Camera), will show the type of permission granted to that item and allow the user to select a different type of permission
    ...
    ![WhatsApp Image 2025-11-27 at 1.16.59 PM.jpeg](./images/WhatsApp_Image_2025-11-27_at_1.16.59_PM.jpeg)
...
![WhatsApp Image 2025-11-26 at 1.16.08 PM.jpeg](./images/dd233bef-e28d-45a4-9712-a04e921ad2ca.png)

- Trying to exchange collected data

![WhatsApp Image 2025-11-26 at 12.45.53 PM(1).jpeg](./images/c777d44e-7254-4dd3-9370-df8d43f4e3ed.png)
