...
![2025-08-26_10-17.png](./images/2025-08-26_10-17.png)

***Step 2:*** Open :comapeo-platform: CoMapeo and, in the main menu, **select the project** where the new category set in needed.
...
**Warning:** This is not visible to Participants of a project

</aside>

***Step 3:** Select* **Project Categories**. 

![1000000070.png](./images/1000000070.png)

***Step 4:** Tap* **Import Categories** to open the file picker of your operating system

![1000000071.png](./images/1000000071.png)

***Step 5:*** Find the category set file (.comapeocat) and select it. CoMapeo will attempt import the file selected. If successful, information on the Catergories screen will be updated 
